...
//        }
    ...
    private void makeLocations() {
        ...
        /*{
            ...
            Location node0 = new Location("Entrance", new ArrayList<String>(Arrays.asList("Balcony", places[4], places[1])), new ArrayList<Integer>(Arrays.asList(PlacePosition.left, PlacePosition.bottomLeft, PlacePosition.topLeft)),R.drawable.three0, 3, false, 180f, null, null, null, null, null);
            ...
            makeConnections(node0,node1,node2,node3,node4,node5,stairs1);
            node0.setAngle(180);
            node3.setAngle(180);
            node2.setAngle(-90);
            stairs1.setAngle(180);
